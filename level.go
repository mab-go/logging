...
// Custom slog levels used to represent FATAL and PANIC, since slog has no
// native constants for them. They sit above slog.LevelError (which is 8).
const (
...
// slogLevel maps a Level to the slog.Level used by the slog backend.
